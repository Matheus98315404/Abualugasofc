...
-- -----------------------------------------------------
-- Table `bd_abualugas`.`veiculosalugueis`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bd_abualugas`.`veiculosalugueis` (
  `veiculos_id_veiculo` INT NOT NULL,
  `alugueis_id_aluguel` INT NOT NULL,
  `km_inicial` INT(6) NOT NULL,
  `km_final` INT(6) NOT NULL,
  PRIMARY KEY (`veiculos_id_veiculo`, `alugueis_id_aluguel`),
  INDEX `fk_veiculos_has_alugueis_alugueis1_idx` (`alugueis_id_aluguel` ASC) VISIBLE,
  INDEX `fk_veiculos_has_alugueis_veiculos1_idx` (`veiculos_id_veiculo` ASC) VISIBLE,
  CONSTRAINT `fk_veiculos_has_alugueis_veiculos1`
    FOREIGN KEY (`veiculos_id_veiculo`)
    REFERENCES `bd_abualugas`.`veiculos` (`id_veiculo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_veiculos_has_alugueis_alugueis1`
